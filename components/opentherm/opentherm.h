...
class OpenThermComponent : public PollingComponent {
 public:
  ...
  void set_otc_ratio_sensor(sensor::Sensor *sensor) { otc_ratio_sensor_ = sensor; }
 ...
 private:
  ...
  uint32_t last_millis_otc_ratio_upper_ = 0;
  uint32_t last_millis_otc_ratio_lower_ = 0;
  uint32_t last_millis_otc_ratio_ = 0;
