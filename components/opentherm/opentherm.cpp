...
void OpenThermComponent::setup() {
  ...
  unsigned long request3 = OpenThermComponent.buildRequest(OpenThermRequestType::READ, OpenThermMessageID::SConfigSMemberIDcode, 0xFFFF);
  unsigned long respons3 = OpenThermComponent.sendRequest(request3);
  ...
  unsigned long request2 = OpenThermComponent.buildRequest(OpenThermRequestType::WRITE, OpenThermMessageID::MConfigMMemberIDcode, SlaveMemberIDcode);
  unsigned long respons2 = OpenThermComponent.sendRequest(request2);
  ESP_LOGD ("opentherm_component", "MConfigMMemberIDcode %X",  request2 ); 

  unsigned long request127 = OpenThermComponent.buildRequest(OpenThermRequestType::READ, OpenThermMessageID::SlaveVersion, 0);
  ESP_LOGD ("opentherm_component", "SlaveVersion %X",  request127 ); 

  unsigned long request126 = OpenThermComponent.buildRequest(OpenThermRequestType::WRITE, OpenThermMessageID::MasterVersion, 0x013F);
  unsigned long respons126 = OpenThermComponent.sendRequest(request126);
